...
export class ProductsPage {
    ...
    constructor(public nav: NavController, public popoverCtrl: PopoverController, public service: CategoryService, 
                params: NavParams, public values: Values, public functions: Functions) {
        this.data = {};
        this.filter = {};
        this.q = "";
        this.filter['filter[category]'] = params.data.slug;
        this.nombre_categoria = params.data.slug.replace("-mujer", "");
        this.logo = 'assets/image/blazer.png';
        this.values.listview = true;
        /*switch (params.data.slug) {
            case "complementos-mujer":  this.filter['filter[category]'] =  this.filter['filter[category]'] + "+" + "complementos"; break;
            default: break;
        }*/
        this.filter.id = params.data.id;
        /*switch (this.filter.id) {
            case 213: this.filter.id = this.filter.id + "+" + 245; break;
            default: break;
        }*/
        this.filter.page = 1;
